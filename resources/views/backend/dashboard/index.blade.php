...
@section('container')
    <div class="py-8">
        ...
        <div class="bg-white border-2 border-pink-500 text-gray-900 p-8 rounded-xl shadow-xl hover:shadow-xl transition-all duration-300 mt-12">
            ...
            <ul class="list-disc pl-5 mt-4 text-gray-700 space-y-2">
                <li><strong>Help Center:</strong> Visit the <a href="https://github.com/kamrulkafi1" class="text-blue-600 hover:text-blue-800">Help Center</a> for frequently asked questions and guides.</li>
                <li><strong>Contact Support:</strong> Reach out to our support team via email at <a href="mailto:kamrulkafi1@gmail.com" class="text-blue-600 hover:text-blue-800">kamrulkafi1@gmail.com</a>.</li>
